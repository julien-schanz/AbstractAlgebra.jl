...
function force_coerce(a, b; throw_error::Bool = true)
  throw_error && throw(error("Coercion not possible"))
  return false
end
...
function force_op(op::T, a...; throw_error::Bool = true) where {T}
  throw_error && throw(error("No common overstructure for the arguments found"))
  return false
end
